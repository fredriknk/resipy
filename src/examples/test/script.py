import sys
sys.path.append("/home/fredrikfnk/PycharmProjects/resipy/src")
...
if __name__ == '__main__':
    ...
    t0 = time.time()
    k = Project(typ='R2')
    k.createPseudo3DSurvey(r'/home/fredrikfnk/PycharmProjects/resipy/src/examples/test/data',
                           lineSpacing=20, ftype="ResInv")
    k.importPseudo3DElec(r'/home/fredrikfnk/PycharmProjects/Resipy_interpolate/topofiles/electrodes3d.csv')
    ...
    k.showResults(index=-1, cropMesh=False, color_map='jet', vmin=0.8, vmax=4,cropMaxDepth=False,clipContour=False,contour=True,background_color=(1.,1.,1.))
